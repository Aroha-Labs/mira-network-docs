---
description: "Learn how to build your own elemental flow using Mira Flows SDK"
title: "Build Elemental Flows"
icon: "puzzle-piece"
iconType: "light"
---

## Video Tutorial
<iframe width="560" height="315" src="https://www.youtube.com/embed/S-iSE04gwNQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />

<br />

<Tip>Check out this <a href="https://github.com/B-Venkatesh7210/building-your-own-flows" target="_blank">Github Repository</a> for a quick overview on how to build an Elemental Flow.</Tip>
...
<Steps>
  <Step title="Configuration: Define your elemental flow using YAML" />

  <Step title="Testing: Validate the flow's functionality" />

  <Step title="Deployment: Make your flow available" />

  <Step title="Execution: Run your flow in production" />

  <Step title="Updates: Iterate and improve" />
</Steps>
...
<Card title="Build Elemental Flows" icon="github" href="https://github.com/B-Venkatesh7210/building-your-own-flows">
