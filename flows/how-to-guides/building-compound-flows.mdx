...
<Steps>
  <Step title="Configuration: Define your compound flow using YAML" />

  <Step title="Testing: Validate the entire processing pipeline" />

  <Step title="Deployment: Make your flow available" />

  <Step title="Execution: Run your multi-stage flow in production" />
